...
# histogram of the Global_active_power variable of the data frame dpower
hist(dpower$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
